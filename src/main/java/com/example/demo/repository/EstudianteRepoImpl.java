...
public class EstudianteRepoImpl implements IEstudianteRepo{
	...
	@Override
	public List<EstudianteDTO> seleccionarTresArgsDTO() {
		//crea un EstudianteDTO mediante la tabla Estudiante
		//EstudianteDTO debe incluir el nombre completo, incluido el paquete
		TypedQuery<EstudianteDTO>myQuery = this.entityManager.createQuery("SELECT NEW com.example.demo.repository.modelo.dto.EstudianteDTO(e.nombre,e.apellido,e.peso) FROM Estudiante e",EstudianteDTO.class);
		return myQuery.getResultList();
	}
